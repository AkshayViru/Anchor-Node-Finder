...
G.add_edge((0,0),(0,limit/2))
G.add_edge((limit-1,0),(limit-1,limit/2))
for j in range(1, limit/2):
	G.add_edge((0,j),(0,limit-j))
	G.add_edge((limit-1,j),(limit-1,limit-j))
...
while nloops<=llno:
	...
	print nloops, "minimum APL = ",distance, " node 1 =",(node1a, node1b), " node 2=" ,(node2a, node2b) 
